      ...
      <VStack align="stretch" gap={8} maxW="5xl" mx="auto" px={8}>
        ...
        <Box>
          ...
          <Text color="gray.700" fontSize="md" lineHeight="tall">
            ...
            developed for multimodal clinical data. This system removes all Protected Health
            ...
            placeholders. The audio is de-identified by replacing PHI with tones and transforming
            the voices to prevent speaker identification. Video de-identification is achieved
            through the blurring of the frame and the addition of keypoints over the figures. As a
            final step, the de-identified audio and video are re-synchronized to provide a fully
            de-identified version of the recorded clinical encounter. All data run through the
            pipeline undergo a rigorous manual review, where any missed PHI is flagged and then
