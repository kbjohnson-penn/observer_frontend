  ...
  return (
    <Box textAlign="center" mb={12}>
      ...
      <Text 
        ...
        lineHeight="tall"
      >
        Comprehensive multimodal clinical encounter data for healthcare research. 
        Real outpatient visits captured through video, audio, transcripts, EHR data, 
        and surveys - all de-identified and structured for analysis.
      </Text>
