...
import { Box, Card, HStack, VStack, Text, Badge } from '@chakra-ui/react';
          ...
          {activeCapabilities.length > 0 && (
            <HStack gap={1} flexWrap="wrap">
              {activeCapabilities.map((cap) => (
                <Badge key={cap} colorPalette="gray" variant="subtle" size="xs" borderRadius="full">
                  {cap}
                </Badge>
              ))}
            </HStack>
              ...
              {hit.drug_count > 0 &&
                (drugHighlight ? (
                  <Badge colorPalette="gray" size="sm">
                    <span dangerouslySetInnerHTML={{ __html: sanitizeHighlight(drugHighlight) }} />
                  </Badge>
                ) : (
                  <Badge colorPalette="gray" size="sm">
