...
describe('useDatasetExplorer', () => {
  const mockApiResponse: SampleDataAPIResponse = {
    persons: [
      { person_id: 1, gender_concept_id: 8507, year_of_birth: 1980, race_concept_id: 8527, ethnicity_concept_id: 38003563 },
      { person_id: 2, gender_concept_id: 8532, year_of_birth: 1975, race_concept_id: 8516, ethnicity_concept_id: 38003564 },
    ],
    providers: [
      { provider_id: 1, provider_name: 'Dr. Smith', gender_concept_id: 8507, year_of_birth: 1970, specialty_concept_id: 38004453 },
    ],
    visits: [
      { visit_occurrence_id: 1, person_id: 1, visit_concept_id: 9201, visit_start_date: '2024-01-01', visit_start_datetime: '2024-01-01T10:00:00', visit_type_concept_id: 44818518 },
      { visit_occurrence_id: 2, person_id: 2, visit_concept_id: 9202, visit_start_date: '2024-01-02', visit_start_datetime: '2024-01-02T14:00:00', visit_type_concept_id: 44818519 },
    ],
    notes: [],
    conditions: [],
    drugs: [],
    ...
    measurements: [],
    observations: [
      { observation_id: 1, person_id: 1, observation_concept_id: 4219336, observation_date: '2024-01-01', file_type: 'patient_view', file_path: 'video1.mp4' },
      { observation_id: 2, person_id: 1, observation_concept_id: 4219336, observation_date: '2024-01-01', file_type: 'provider_view', file_path: 'video2.mp4' },
      { observation_id: 3, person_id: 1, observation_concept_id: 4219336, observation_date: '2024-01-01', file_type: 'room_view', file_path: 'video3.mp4' },
      { observation_id: 4, person_id: 1, observation_concept_id: 4219336, observation_date: '2024-01-01', file_type: 'transcript', file_path: 'transcript.json' },
    ],
    patient_surveys: [],
    provider_surveys: [],
    audit_logs: [],
