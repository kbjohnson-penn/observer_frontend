...
export const USAGE_ETHICS: UsageEthics = {
  ...
  publisher={Cold Spring Harbor Laboratory Press}
    ...
    chicago:
      'Johnson, Kevin B., Basam Alasaly, Kuk Jin Jang, Eric Eaton, Sriharsha Mopidevi, and Ross Koppel. "The Observer Repository: Advancing Ambulatory Care Innovation Through Video-Based Clinical Ethnography." medRxiv (2025): 2025-05.',
    harvard:
      'Johnson, K.B., Alasaly, B., Jang, K.J., Eaton, E., Mopidevi, S. and Koppel, R., 2025. The Observer Repository: Advancing Ambulatory Care Innovation Through Video-Based Clinical Ethnography. medRxiv, pp.2025-05.',
    vancouver:
      'Johnson KB, Alasaly B, Jang KJ, Eaton E, Mopidevi S, Koppel R. The Observer Repository: Advancing Ambulatory Care Innovation Through Video-Based Clinical Ethnography. medRxiv. 2025:2025-05.',
  },
  dataUseAgreement: {
    ...
    sections: [
      {
        ...
        content:
          'This dataset may be used for academic research, educational purposes, and non-commercial healthcare informatics studies. Users must obtain appropriate IRB approval when required by their institution.',
      },
      {
        title: 'Restrictions',
        content:
          'Commercial use is prohibited without explicit written permission. Re-identification attempts are strictly forbidden. Data may not be redistributed or shared outside approved research teams without permission.',
      },
      {
        title: 'Attribution Requirements',
        content:
          'All publications, presentations, or derivative works must cite the dataset using the provided citation format. Acknowledgment of the data contributors and funding sources is required.',
      },
      {
        title: 'Data Security',
        content:
          'Users must implement appropriate technical and administrative safeguards to protect the data. Access should be limited to authorized research team members only.',
      },
      {
        title: 'Publication Guidelines',
        content:
          'Research findings should be reported in aggregate form. Individual case details should not be presented in ways that could potentially enable re-identification.',
      },
    ],
  },
  privacy: {
    ...
    dataRetention:
      'Dataset will be maintained for a minimum of 10 years to support reproducible research. Access controls and monitoring will be maintained throughout the retention period.',
  },
  version: {
    current: '1.0',
