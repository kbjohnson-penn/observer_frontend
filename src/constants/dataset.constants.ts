  ...
  categories: [
    ...
    },
    {
      ...
      tables: [
        ...
        { name: "VISIT_OCCURRENCE", description: "Clinical encounters with timing and context", icon: "hospital" },
        { name: "CONDITION_OCCURRENCE", description: "Diagnoses and medical conditions", icon: "file" },
...
export const ACCESS_REQUIREMENTS: AccessRequirements = {
  updateNote: "This section is being updated with detailed access procedures. Please check back soon.",
  sections: [
    {
